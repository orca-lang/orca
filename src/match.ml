...
let check_ppar (sign : signature) (p1 : pats) (n : name) (cD1 : I.ctx)
  ...
  compute_split_map sign (x, I.Var n) (x, I.PTBox(g, I.PPar (n, None))) cD1 x cD2 [] [] (cD1 @ [n, I.Box (g, t)])
  (* the None breaks pattern matching*)
...
let split_rec (sign : signature) (ps : pats) (cD : I.ctx) : I.ctx * I.pats =
  ...
  and search_apx p1 p ps cD1 cD2 =
    ...
    | A.PPar (y, _), (x, t) :: cD2 ->(* and pattern matching broke*)
